...
userRoutes.post("/auth-status", tokenManager_1.verifyToken, userControllers_1.default.verifyUser);
userRoutes.post("/logout", tokenManager_1.verifyToken, userControllers_1.default.userLogout);
