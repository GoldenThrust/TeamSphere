          ...
          <Box sx={{ width: "100%" }}>
            ...
            >
              ...
              <Grid xs={6} sx={{marginTop: "10ch"}}>
                ...
                <Item>
                  Work together in real-time, <br/> no matter where your team members 
                  are located, with<br/> seamless and instant communication <br/> and
                  sharing.
                </Item>
              </Grid>
              <Grid xs={6}  sx={{marginTop: "10ch"}}>
                ...
                <Item>
                  Intuitive design and user-friendly <br/>interface make it easy for <br/>
              ...
              <Grid xs={6}  sx={{marginTop: "10ch"}}>
                ...
                <Item>
                  Rest assured knowing that your data<br/> is safe and your 
                  communication<br/> is secure with our robust security<br/> measures and
